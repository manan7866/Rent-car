...
import ViewA from "@/public/images/ViewA.png"
...
export default function Detail (){
    ...
    return(
        <div className="w-full flex xs:px-4 xs:py-4 md:px-6 md:py-6  sm:px-6 sm:py-6 bg-[#E0E9F4] h-full ">
            <div className=" w-[500px] xs:hidden sm:hidden bg-white md:hidden lg:hidden xl:hidden h-auto 2xl:w-[255px] px-8 py-10 ">
      ...
      <div className="flex flex-col gap-6 my-12">
          ...
          <div className="h-auto flex flex-col gap-6 ">
           ...
           <p className="text-slate-400">(16)</p>
            ...
            <div className="py-6 px-4 xs:px-0 sm:px-0 md:px-0 w-full">
            ...
            <div className="col-span-1 row-span-1 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 grid sm:py-1 xs:py-1 md:py-2 py-8 xl:grid-cols-3 md:gap-x-8 md:gap-y-4 gap-y-6 gap-x-10 2xl:grid-cols-3 grid-cols-6 grid-rows-4  ">
                ...
                <div  tabIndex={0}  style={{backgroundImage: "url(images/View.jpg)", backgroundSize: "cover",}} className=" rounded-xl  focus-visible:ring-blue-500 focus:ring-2 focus:ring-blue-400 focus:py-8 focus:px-8 focus:outline-2 col-span-3 row-span-3 "></div>
                <div  tabIndex={0} className="xs:hidden xl:hidden sm:hidden md:hidden lg:hidden 2xl:hidden focus-visible:ring-blue-500 focus:ring-2 focus:ring-blue-400 focus:py-8  focus:outline-2 bg-white col-span-3 rounded-xl row-span-4 flex justify-between py-6 px-6 ">
                    ...
                    <div>
                        <div className="text-[28px] font-extralight  text-slate-400 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-4 grid-rows-2 gap-x-[5%] text-[28px] text-slate-300 text-end">
                        ...
                        <p>Capacity</p>
                        <p className="text-slate-400 text-end">2 Person</p>
                        <p className="text-start">Steering</p>
                        <p className="text-slate-400 ">Manual</p>
                        <p>Gasoline</p>
                        <p className="text-slate-400 text-end">70L</p>
                    </div>
                      <div>
                        <div className="w-full flex justify-between ">
                            <div className="flex items-end py-2">
                                <p className="text-5xl">$80.00/</p>
                        ...
                        <div>
                            <p className="text-slate-400 text-xl">$100.00</p>
                        </div>
                      </div>
                    </div>
                </div>
                <Image tabIndex={0} className="col-span-1 row-span-1   h-full w-full rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:py-2 focus:px-2 " src={ViewA} alt="car"/>
            ...
            <div  tabIndex={0} className="  focus-visible:ring-blue-500 focus:ring-2 focus:ring-blue-400 focus:py-8  focus:outline-2 bg-white col-span-3 rounded-xl row-span-4 flex justify-between xs:px-3 xs:py-4 sm:px-3  py-6 px-6 ">
                    ...
                    <div className="flex justify-between w-full">
                    <div className="">
                        <p className="text-4xl md:text-3xl sm:text-2xl xs:text-xl font-bold">Nissan GT - R</p>
                    ...
                    <div>
                        ...
                        <div className="text-[28px] md:text-[22px] xs:text-[12px] xs:my-4 sm:text-[16px] xl:hidden font-extralight  text-slate-400 flex flex-col gap-4">
                      ...
                      <div>
                        <div className="w-full flex items-center mt-6 justify-between ">
                            <div className="flex items-end xs:pb-0 py-2">
                                <p className="text-5xl md:text-4xl xs:text-xl sm:text-3xl">$80.00/</p>
                        ...
                        <div>
                            <p className="text-slate-400 md:text-lg md:mb-4 xs:text-xs  sm:text-sm text-xl">$100.00</p>
                        </div >
                      </div>
                    </div>
                </div></div>
            ...
            <div className="py-8 xs:px-0 xs:py-0 sm:px-0 sm:py-0 md:px-0 md:py-0 px-8 ">
              <div className="w-full flex justify-between my-8 px-4 py-2 text-lg">
               ...
               <a className="text-blue-500">View All</a>
                ...
                <div className="flex xs:gap-4 sm:gap-4 2 2xl:gap-4 md:gap-4 lg:gap-6 gap-x-14 xl:gap-8 custom-scroll overflow-x-auto justify-between ">
                {recentcArr.map((c)=>{
              return(
                
                  <Car key={c.carcatagory} className="2xl:w-[315px] xl:w-full" carname={c.carname} carcatagory={c.carcatagory} carpic={c.carpic} carfuel={c.carfuel} cardrive={c.cardrive}
            ...
            <div className="py-8 xs:px-0 xs:py-0 sm:px-0 sm:py-0 md:px-0 md:py-0 px-8 ">
              <div className="w-full flex justify-between my-8 px-4 py-2 text-lg">
               ...
               <a className="text-blue-500">View All</a>
                ...
                <div className="flex md:gap-4 sm:gap-4 xs:gap-4 2xl:gap-4 lg:gap-6 gap-x-14 xl:gap-8 custom-scroll overflow-x-auto justify-between ">
                {recocar.map((c)=>{
              return(
