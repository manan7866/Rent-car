  ...
  return (
    <div  className={`h-auto lg:h-auto  w-full bg-white px-6 py-6 rounded-md ${className}`}>
      ...
      <div className="h-[180px] md:h-[40%] xs:h-[40%] sm:h-[40%] lg:h-[40%] flex 2xl:mr-20 items-center">
        <Image src={carpic} alt="carpic" className="2xl:w-[200px] xs:h-14 xs:w-[140px] sm:h-20 md:h-40 lg:h-44" />
      </div>
      ...
      {/* <div className="flex justify-between items-center h-auto">
        <div className="flex items-end text-xl font-bold relative top-3">
          {carprice} <p className="text-slate-300 text-sm font-normal text-end pl-1">day</p>
        </div>
        <button className="w-[144px] h-[50px] text-xl bg-blue-400 rounded-md text-white lg:mt-2 mt-8">
          Rental Now
        </button>
      </div>
      <div className='text-slate-300 py-8 relative bottom-3'>{carptwo}</div> */}
      <div className="flex justify-between items-center h-auto">
        <div className="flex items-start text-2xl xs:text-lg font-bold relative top-3">
          <div>
          {carprice}
          <div className='text-slate-300 text-lg  xs:text-sm  '>{carptwo}</div> 
